      ...
      <div className="max-w-7xl mx-auto px-4 pt-16 pb-8 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4 lg:grid-cols-5">
          ...
          <div className="col-span-2 lg:col-span-1">
            ...
            <p className="font-schibsted text-sm leading-relaxed text-pretty">
              The world&apos;s first comprehensive platform for Generative
              Engine Optimization — track, analyze, and grow your AI visibility.
            </p>
          </div>
        ...
        <div className="mt-16 pt-8 border-t border-zinc-800 flex flex-col items-center justify-between gap-4 md:flex-row">
          <div className="flex gap-4 flex-wrap">
            <span className="font-schibsted text-xs">
              © 2026 GEO Platform Inc.
            </span>
            <Link
              href="/terms"
              className="font-schibsted text-xs hover:text-white transition-colors"
            >
              Terms
            </Link>
            <Link
