...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen bg-gradient-to-b from-sky-400 via-blue-600 to-blue-800 flex flex-col items-center pt-0 px-4 text-center pb-16">
      ...
      <Container className="relative z-10 mx-auto mt-12">
        ...
        >
          <Heading className="max-w-5xl mx-auto">
            <span className="font-extralight tracking-tighter text-neutral-100">
              Simple management for{" "}
            </span>
            <br />
            <span className="font-medium tracking-widest text-neutral-100/80">
              remote team
            </span>
          </Heading>
        </motion.div>
        ...
        >
          <Subheading variant="herosubHeading" className="text-neutral-100/80">
            Standard SEO is dead. Analyze and optimize your visibility across AI
            models.
          </Subheading>
        </motion.div>
      ...
      <div className="hidden md:block relative z-10 w-[95%] md:w-[88%] max-w-5xl mx-auto mt-12">
        <HeroDashboard />
      </div>
    </section>
  );
