      ...
      >
        ...
        <div className="grid gap-1.5">
          {payload.map((item: RechartsPrimitive.TooltipPayloadEntry, index: number) => {
            ...
            return (
              <div
                key={typeof item.dataKey === 'function' ? String(item.name ?? index) : String(item.dataKey ?? index)}
                className={cn(
  ...
  return (
    ...
    >
      {payload.map((item: RechartsPrimitive.LegendPayload) => {
        ...
        return (
          <div
            key={typeof item.dataKey === 'function' ? String(item.value) : String(item.dataKey ?? item.value)}
